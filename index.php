...
<body>
				...
				<div class="container">
					<div class="home__inner">
						<div class="home__items">
							...
							<p class="home__subtitle text">Kamu pengen punya skin bagus kayak gini?</p>
							<a href="#menu" class="home__link btn" id="topUpButton">Top Up Sekarang</a>
						</div>
						<div class="home__slider">
							<div class="home__image">
								<img src="img/yss.png" alt="home img" class="home__img img">
							</div>
							<div class="home__image">
								<img src="img/gr.png" alt="home img" class="home__img img">
							</div>
							<div class="home__image">
								<img src="img/pharsa.png" alt="home img" class="home__img img">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="contact__inner">
						...
						<form action="#">
							<div class="contact__form">
								<a href="https://api.whatsapp.com/send?phone=6287825484134&text=Boleh%20minta%20list%20topupnya?%20" class="footer__social">
									<img src="img/wa.png" alt="footer img" class="footer__img img">
								</a>
								<a href="https://instagram.com/fredoakhmad?igshid=MzMyNGUyNmU2YQ==" class="footer__social">
  ...
  <div class="isi-footer">
    ...
    <h4>Fresieshop</h4>
    <p id="copyright">CopyRight@akhmadsultoni, 2023</p>
  </div>
</footer>
